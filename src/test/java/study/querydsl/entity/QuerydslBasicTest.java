...
public class QuerydslBasicTest {
    ...
    @BeforeEach
    public void before() {
        queryFactory = new JPAQueryFactory(em);     //동시성 문제 알아서 해결됨
...
//        QMember m = new QMember("m");   //m=어떤 Q맴버인지 구분하는 이름(별칭을 주는 느낌)
...
//                .select(Wildcard.count)   //= count(*)
    ...
    public void group() throws Exception {
        ...
        List<Tuple> result = queryFactory
                ...
                .from(member)
                .join(member.team, team)        // member의 team과 team을 조인해줌
                .groupBy(team.name)
                .fetch();
    ...
    public void bulkUpdate() throws Exception {
        ...
        //member1 = 10 -> 1차 캐시: member1 / DB: 비회원
        //member2 = 20 -> 1차 캐시: member2 / DB: 비회원
        //member3 = 30 -> 1차 캐시: member3 / DB: member3
        //member4 = 40 -> 1차 캐시: member4 / DB: member4
